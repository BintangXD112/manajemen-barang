            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
                ...
                <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        <div className="mb-6">
                            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Tambah Barang Baru</h2>
                            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Lengkapi informasi barang yang ingin ditambahkan</p>
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm"
                                    placeholder="Contoh: Elektronik, Pakaian, Makanan, dll"
                                />
